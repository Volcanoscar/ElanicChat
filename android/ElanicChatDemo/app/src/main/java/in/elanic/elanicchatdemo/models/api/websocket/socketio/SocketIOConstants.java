...
public class SocketIOConstants {
    ...
    public static final String EVENT_SET_QUOTATIONS_DELIVERED_ON = "setQuotationsDeliveredOn";
    public static final String EVENT_SET_MESSAGES_DELIVERD_ON = "setMessagesDeliveredOn";
    public static final String EVENT_SET_QUOTATIONS_READ_AT = "setQuotationsReadAt";
    public static final String EVENT_SET_MESSAGES_READ_AT = "setMessagesReadAt";
